-- ----------------------------------------------------------------------------
-- 02-staging-sqoop-mirrors: 27 Sqoop-landed RDBMS mirror tables
...
-- Partition: Hive PARTITIONED BY (load_date STRING) promoted to load_date DATE.
...
-- collapsed to single BQ partition by load_date + CLUSTER BY site_code.
...
-- ============================================================================
-- Telephony switch on Oracle (switchdb01)                                  [5]
-- ============================================================================

-- stg_tel_call: Hive CLUSTERED BY (call_id) INTO 16 BUCKETS preserved as
-- BQ CLUSTER BY call_id (bucket count has no BQ equivalent).
...
-- ============================================================================
-- Ticketing on Postgres (tixdb01)                                         [3]
-- ============================================================================
...
-- ============================================================================
-- Finance/billing on SQL Server (findb01)                                 [3]
-- ============================================================================
