-- ----------------------------------------------------------------------------
-- 06-ods-delta-scd2: 8 delta-merged entities + 3 SCD-2 history tables
-- Migrated from Hive ODS layer on nbcs-cdh-prod (CDH 6.3.4).
--
-- Delta-merged tables: STRING month/date partition columns promoted to DATE
--   (e.g. work_month 'YYYY-MM' stored as first-of-month DATE).
-- SCD-2 tables: RANGE_BUCKET partitioned by eff_from_year INT64.
...
-- ============================================================================
-- SCD-2 history tables (3) — RANGE partitioned by eff_from_year
-- ============================================================================
...
PARTITION BY RANGE_BUCKET(eff_from_year, GENERATE_ARRAY(2018, 2031, 1));
