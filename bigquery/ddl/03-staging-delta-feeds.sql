-- ----------------------------------------------------------------------------
-- 03-staging-delta-feeds: 8 CDC delta feed tables (pipe-delimited TEXTFILE)
...
-- Partition: Hive PARTITIONED BY (extract_ts STRING) promoted to extract_ts DATE.
...
-- No ROW FORMAT / TEXTFILE references — standard BQ tables.
-- ----------------------------------------------------------------------------
