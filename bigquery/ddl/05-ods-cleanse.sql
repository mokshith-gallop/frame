-- ----------------------------------------------------------------------------
-- 05-ods-cleanse: 15 cleansed/conformed ODS tables
-- Migrated from Hive ODS layer on nbcs-cdh-prod (CDH 6.3.4).
--
-- All timestamps are TIMESTAMP (ODS is post-cast layer).
-- Partition: Hive PARTITIONED BY (snapshot_date/sched_date/event_date/
--   call_date STRING) promoted to DATE columns.
